                  ...
                  <TableCell>
                    ...
                    {missingFromRegistry ? (
                      <p className="text-warning mt-1 flex items-center gap-1.5 text-xs">
                        ...
                        />
                        Aucune page ne correspond à cet identifiant dans le
                        code : cet outil restera invisible côté client, même
                        activé.
                      </p>
                    ) : null}
                  </TableCell>
                  <TableCell>
                    <Badge variant={tool.kind === "external" ? "outline" : "secondary"}>
